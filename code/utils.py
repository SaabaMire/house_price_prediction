...
# Load training columns and scaler
TRAIN_COLUMNS = json.load(open("models/train_colums.json"))
SCALER = joblib.load("models/house_scaler.pkl")

# Convert raw input record into a DataFrame with all features needed for prediction.
